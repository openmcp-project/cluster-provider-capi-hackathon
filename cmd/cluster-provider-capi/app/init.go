...
import (
	...
	"github.com/openmcp-project/cluster-provider-capi/api/crds"
...
func NewInitCommand(so *SharedOptions) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "init",
		Short: "Initialize the CAPI cluster provider (install CRDs)",
...
func (o *InitOptions) PrintRawOptions(cmd *cobra.Command)       { o.SharedOptions.PrintRaw(cmd) }
func (o *InitOptions) PrintCompletedOptions(cmd *cobra.Command) { o.SharedOptions.PrintCompleted(cmd) }
